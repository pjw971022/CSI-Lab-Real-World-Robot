...
def plot_predictions(input_image, text_queries, scores, boxes, labels, score_threshold):
    ...
    plt.savefig('/home/pjw971022/Sembot/real_bot/save_viz/obs/detected_obs.png')


# Download sample image
image_path = '/home/pjw971022/Sembot/real_bot/save_viz/obs/rgb_obs.png'  #skimage.data.astronaut()
