...
class TwoStreamClipLingUNetTransporterAgent(TransporterAgent): # @1
    ...
    def attn_forward(self, inp, softmax=True):
        ...
        # p0 = inp['p0']
        # e.g. 'put the yellow blocks in a green bowl' >> put the yellow blocks(pick pose:{}) in a green bowl(place pose:{})
        # new_lang_goal = lang_goal + f'po: {p0}'
    ...
    def act(self, obs, info, goal=None):  # pylint: disable=unused-argument
        ...
        # yaw_predict = self.yaw_forward(pick_inp)
...
class TwoStreamClipLingUNetLatTransporterAgent(TwoStreamClipLingUNetTransporterAgent): # @2
    def __init__(self, name, cfg, train_ds, test_ds):
        super().__init__(name, cfg, train_ds, test_ds)
